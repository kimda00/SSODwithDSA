...
def ap_per_class(tp, conf, pred_cls, target_cls, plot=False, save_dir='.', names=()):
    ...
    if plot:
        plot_pr_curve(px, py, ap, Path(save_dir) / f'PR_curve.png', names)
        plot_mc_curve(px, f1, Path(save_dir) / f'F1_curve.png', names, ylabel='F1')
        plot_mc_curve(px, p, Path(save_dir) / f'P_curve.png', names, ylabel='Precision')
        plot_mc_curve(px, r, Path(save_dir) / f'R_curve.png', names, ylabel='Recall')
