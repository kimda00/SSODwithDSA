...
class WandbLogger():
    ...
    # def log_confusion_matrix(self, confusion_matrix_path):
    #     """
    #     Log confusion matrix image to W&B.
        
    #     arguments:
    #     confusion_matrix_path (str) -- path to the confusion matrix image
    #     """
    #     if self.wandb_run:
    #         self.wandb_run.log({"confusion_matrix": wandb.Image(confusion_matrix_path)})
